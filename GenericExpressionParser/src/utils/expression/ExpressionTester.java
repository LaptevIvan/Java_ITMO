...
import static utils.base.Asserts.assertEquals;
import static utils.base.Asserts.assertTrue;
...
public class ExpressionTester<E extends ToMiniString, C> extends Tester {
    ...
    private void checkToString(final String method, final String expected, final String actual) {
        counter.test(() -> assertTrue(
                "Invalid %s\n     expected: %s\n       actual: %s".formatted(method, expected, actual),
    ...
    private void check(
        ...
        counter.test(() -> assertEquals(
                "f(%s)\nwhere f is %s".formatted(vars, full),
    ...
    private final class Generator {
        private final utils.expression.common.Generator<C> generator;
        ...
        private Generator(
            ...
            generator = new utils.expression.common.Generator<>(random(), () -> randomValue.apply(random()));
