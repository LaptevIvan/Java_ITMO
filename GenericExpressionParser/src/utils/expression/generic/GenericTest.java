...
import utils.expression.common.Op;
...
public final class GenericTest {
    ...
    /* package-private */
    static Consumer<GenericTester> unary(final String name) {
        return tester -> tester.unary(name);
    }

    /* package-private */
    static Consumer<GenericTester> binary(final String name, final int priority) {
